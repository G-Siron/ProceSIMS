...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_dD.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(0, _translate("Form", "D/H"))
        self.comboBox_selection.setItemText(1, _translate("Form", "H (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "D (cps)"))

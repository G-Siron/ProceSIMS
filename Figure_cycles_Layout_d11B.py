...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_d11B.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(0, _translate("Form", "11B/10B"))
        self.comboBox_selection.setItemText(1, _translate("Form", "10B (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "11B (cps)"))

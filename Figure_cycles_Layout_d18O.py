...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_d18O.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(1, _translate("Form", "16O (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "18O (cps)"))

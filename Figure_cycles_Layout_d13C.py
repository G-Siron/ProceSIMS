...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_d13C.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(0, _translate("Form", "13C/12C"))
        self.comboBox_selection.setItemText(1, _translate("Form", "12C (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "13C (cps)"))

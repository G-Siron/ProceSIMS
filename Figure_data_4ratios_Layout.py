...
# Form implementation generated from reading ui file 'Figure_data_4ratios_Layout.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1080, 1081)
        self.Frame_FigData = QtWidgets.QWidget(Form)
        self.Frame_FigData.setGeometry(QtCore.QRect(9, 9, 1061, 1031))
        self.Frame_FigData.setObjectName("Frame_FigData")
        self.pushButton_saveFigure = QtWidgets.QPushButton(Form)
        self.pushButton_saveFigure.setGeometry(QtCore.QRect(930, 1046, 140, 32))

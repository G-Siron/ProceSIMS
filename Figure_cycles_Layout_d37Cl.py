...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_d37Cl.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(0, _translate("Form", "37Cl/35Cl"))
        self.comboBox_selection.setItemText(1, _translate("Form", "35Cl (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "37Cl (cps)"))

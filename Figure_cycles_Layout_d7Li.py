...
# Form implementation generated from reading ui file 'Figure_cycles_Layout_d7Li.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_selection.setItemText(0, _translate("Form", "7Li/6Li"))
        self.comboBox_selection.setItemText(1, _translate("Form", "6Li (cps)"))
        self.comboBox_selection.setItemText(2, _translate("Form", "7Li (cps)"))
